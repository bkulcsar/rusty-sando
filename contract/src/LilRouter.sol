...
contract LilRouter {
    ...
    function calculateSwapV2(
        ...
        uint256 actualAmountIn = ERC20(inputToken).balanceOf(
            address(targetPair)
        ) - reserveIn;
    ...
    function calculateSwapV3(
        ...
        address inputToken,
        address outputToken
    ) public returns (uint256 amountOut, uint256 realAfterBalance) {
        ...
        (int256 amount0, int256 amount1) = targetPool.swap(
            address(this),
            zeroForOne,
            amountIn,
            sqrtPriceLimitX96,
